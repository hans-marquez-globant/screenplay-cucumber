...
public class LoginPage {
    ...
    public static Target ERROR = Target.the("Error text").located(By.cssSelector(".login-form p"));
    public static Target TITLE = Target.the("Login title").located(By.cssSelector(".login-form h2"));
}
