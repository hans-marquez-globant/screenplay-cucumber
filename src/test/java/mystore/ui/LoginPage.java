...
public class LoginPage {
    ...
    public static Target LOGIN_PAGE_TITLE = Target.the("Title in login section").located(By.cssSelector(".login-form h2"));
    public static Target WRONG_LOGIN_WARNING = Target.the("Warning for wrong login attempt").located(By.cssSelector(".login-form p"));
}
