...
public class LoginPage {
    public static Target TITLE = Target.the("Login page title").located(By.cssSelector(".login-form h2"));
    ...
    public static Target LOGIN_ERROR = Target.the("Login error message").located(By.cssSelector(".login-form p"));
}
